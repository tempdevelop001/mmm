	...
	while (1) {
		...
		case ALGO_YESPOWER:
			...
			rc = scanhash_yespower(thr_id, work.data, work.target,
			                      max_nonce, &hashes_done, perslen, 1);
			break;
		case ALGO_YESPOWERR16:
			verstring=2;
			rc = scanhash_yespower(thr_id, work.data, work.target,
			                      max_nonce, &hashes_done, perslen, 2);
			break;
		case ALGO_YESPOWERURX:
			verstring=3;
			rc = scanhash_yespower(thr_id, work.data, work.target,
...
int main(int argc, char *argv[])
{
	...
	//определяем кол-во физических и виртуальных ядер процессора
